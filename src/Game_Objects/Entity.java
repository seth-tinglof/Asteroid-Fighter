...
public abstract class Entity implements Displayable
{
	...
	*/
	 ...
	 * @param shown true if this entity is to be shown, false if not.
	 */
	 ...
	 * @param active true for active or false for inactive.
	 */
	...
	*/
	...
	/**
	 * The default move for an entity. 
	 * Leave blank if entity does not move.
	 */
	 ...
	 */
	public int distanceTo(Entity o){
		return (int) Math.sqrt(Math.pow(getXPos() - o.getXPos(), 2) + Math.pow(getYPos() - o.getYPos(), 2));
	}
